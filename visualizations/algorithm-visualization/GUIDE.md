...
```
visualizations/algorithm-visualization/
├── GUIDE.md
...
```bash
cd visualizations/algorithm-visualization
./build.sh                # everything
...
The UI text, the step explanations, this README and the code are all in English, matching the rest of the
repository.
