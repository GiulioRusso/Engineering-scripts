...
window.CATALOG = [
  ...
  { chapter: '3 · Other', items: [
    { id: 'kadane',         name: 'Kadane',         view: 'array', time: 'O(n)',     space: 'O(1)' },
  ]},
  { chapter: '4 · Stack and Queue', items: [
    { id: 'stack',          name: 'Stack',          view: 'stack', time: 'O(1)',     space: 'O(n)' },
    { id: 'queue',          name: 'Circular Queue',  view: 'queue', time: 'O(1)',    space: 'O(n)' },
  ]},
  ...
  { chapter: '6 · Tree', items: [
    { id: 'tree_basics',    name: 'N-ary Tree',     view: 'tree', time: 'O(n)', space: 'O(h)' },
  ...
  { chapter: '7 · Binary Search Tree', items: [
    ...
    { id: 'bst_delete',     name: 'Delete (3 cases)', view: 'tree', time: 'O(h)', space: 'O(h)' },
  ]},
  ...
  { chapter: '9 · Graphs', items: [
    { id: 'graph_repr',     name: 'Matrix and List', view: 'graph', time: 'O(1) / O(degree)', space: 'O(V²) / O(V+E)' },
  ...
  { chapter: '10 · Shortest Paths', items: [
  ...
  { chapter: '12 · Scheduling', items: [
    ...
    { id: 'scheduling_compare',  name: 'Comparing All Four',      view: 'table', time: '—',         space: '—' },
  ]},
  { chapter: '13 · Synchronization', items: [
    ...
    { id: 'semaphores',          name: 'Semaphores',          view: 'threads', time: 'O(1)', space: 'O(n)' },
  ]},
];
