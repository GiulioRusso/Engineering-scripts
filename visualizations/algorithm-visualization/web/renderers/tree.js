...
(function () {
  ...
  window.RENDERERS.tree = function createTreeRenderer() {
    ...
    function legend() {
      return [
        { color: 'var(--c-selected)', label: 'current node' },
        { color: 'var(--c-frontier)', label: 'descent path' },
        { color: 'var(--c-visited)',  label: 'already visited' },
        { color: 'var(--c-sorted)',   label: 'found / inserted' },
        { color: 'var(--c-excluded)', label: 'pruned subtree' },
      ];
    }
