...
(function () {
  ...
  window.RENDERERS.array = function createArrayRenderer() {
    ...
    function legend() {
      return [
        { color: 'var(--c-compare)',  label: 'being compared' },
        { color: 'var(--c-selected)', label: 'selected' },
        { color: 'var(--c-swap)',     label: 'being swapped' },
        { color: 'var(--c-sorted)',   label: 'sorted / found' },
        { color: 'var(--c-frontier)', label: 'active window' },
        { color: 'var(--c-excluded)', label: 'discarded' },
      ];
    }
