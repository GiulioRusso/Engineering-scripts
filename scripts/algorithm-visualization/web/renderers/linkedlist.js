...
(function () {
  ...
  window.RENDERERS.linkedlist = function createLinkedListRenderer() {
    ...
    function legend() {
      return [
        { color: 'var(--c-selected)', label: 'nodo corrente / puntatore riagganciato' },
        { color: 'var(--c-frontier)', label: 'nodo nuovo, fuori dalla catena' },
        { color: 'var(--c-error)',    label: 'nodo orfano, prima della delete' },
      ];
    }
