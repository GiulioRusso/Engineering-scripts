...
(function () {
  ...
  window.RENDERERS.graph = function createGraphRenderer() {
    ...
    function legend() {
      return [
        { color: 'var(--c-neutral)',  label: 'non visitato' },
        { color: 'var(--c-frontier)', label: 'in frontiera' },
        { color: 'var(--c-visited)',  label: 'visitato' },
        { color: 'var(--c-selected)', label: 'nodo o arco corrente' },
        { color: 'var(--c-sorted)',   label: 'nel percorso / accettato' },
      ];
    }
